...
type
  ...
  [SID_IQueryAssociations]
    ...
    function GetEnum(flags: ASSOCF; assocenum: ASSOCENUM; pszExtra: LPCWSTR; riid: TREFIID; var ppvOut: Pointer): HRESULT; stdcall;
  end;
  {$EXTERNALSYM IQueryAssociation}

function AssocCreate(clsid: TCLSID; const riid: TGUID; out ppv: Pointer): HRESULT; stdcall;
